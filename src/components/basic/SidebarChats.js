        ...
        <div className="sidebar__chats">
            ...
            {searchString === '' && dbUser &&
                dbUser.user.chats.map(chat => (
                    <SidebarChat key={chat._id} chat={chat} setOpenChat={setOpenChat} dbUser={dbUser} setDbUser={setDbUser} openChat={openChat} />
                ))
            }
            ...
            {searchString !== '' &&
                <>
                    ...
                    {searchNewChats.map(chat => (
                        <SidebarChat key={chat._id || Math.floor(Math.random() * 1000) + 1} chat={chat} setOpenChat={setOpenChat} isNewChat={true} dbUser={dbUser} setDbUser={setDbUser} openChat={openChat} />
                    ))}
                </>
            }
